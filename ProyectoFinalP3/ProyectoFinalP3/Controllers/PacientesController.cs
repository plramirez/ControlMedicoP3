...
namespace ProyectoFinalP3.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdPaciente,Cedula,Nombre,Seguro")] Pacientes pacientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdPaciente,Cedula,Nombre,Seguro")] Pacientes pacientes)
        {
            if (ModelState.IsValid)
            {
